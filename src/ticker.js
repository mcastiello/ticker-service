...
class TickerService {
    ...
    set useWindowFunctions(value) {
        ...
        {
            window.setTimeout = value ? originalSetTimeout : this.setTimeout;
            window.clearTimeout = value ? originalClearTimeout : this.clearTimeout;
            window.setInterval = value ? originalSetInterval : this.setInterval;
            window.clearInterval = value ? originalClearInterval : this.clearInterval;
            window.requestAnimationFrame = value ? originalRequestAnimationFrame : this.requestAnimationFrame;
            window.cancelAnimationFrame = value ? originalCancelAnimationFrame : this.cancelAnimationFrame;
